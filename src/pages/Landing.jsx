...
function HeroGeometric({ title1 = "Career", title2 = "Canvas" }) {
      ...
      <div className="relative z-10 container mx-auto px-4 md:px-6 text-center flex flex-col items-center">
        ...
        <motion.div custom={2} variants={fadeUpVariants} initial="hidden" animate="visible">
          <p className="text-base sm:text-lg md:text-xl text-white/40 mb-10 leading-relaxed font-light tracking-wide max-w-xl mx-auto px-4">
            Turning your career story into a compelling digital resume.
          </p>
        </motion.div>

        <motion.div custom={3} variants={fadeUpVariants} initial="hidden" animate="visible" className="flex gap-6 mt-4 flex-wrap justify-center">
          <Link
            to="/builder"
            className="px-6 py-3 rounded-full font-medium tracking-wide border border-rose-400/40 bg-gradient-to-r from-indigo-400/20 via-rose-400/20 to-indigo-400/20 text-white hover:from-indigo-400/30 hover:to-rose-400/30 hover:scale-[1.05] transition-all backdrop-blur-md shadow-[0_8px_32px_rgba(255,255,255,0.15)]"
          >
            Get Started
          </Link>
        </motion.div>
